...
export default function About() {
  ...
  return (
    <div className="flex flex-col w-full min-h-screen bg-[#FFF8F5] dark:bg-gray-900">
      ...
      {/* Mission & Vision */}
      <section className="py-24 px-4 w-full bg-[#FFF8F5] dark:bg-[#09193C]">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#28B8B4]/20 text-[#09193C] dark:text-white text-sm font-medium mb-6">
              <Zap className="h-4 w-4 text-[#28B8B4]" />
              Powering India's Green Future
            </div>
            <h2 className="text-5xl md:text-6xl font-bold text-[#09193C] dark:text-white mb-6">
              Building a <span className="text-[#28B8B4]">Smarter</span> Energy Ecosystem
            </h2>
            <p className="text-xl text-[#2D50A1] dark:text-gray-300 max-w-3xl mx-auto leading-relaxed">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 mb-24">
            ...
            >
              ...
              <div className="relative bg-white dark:bg-[#09193C] rounded-2xl p-8 shadow-2xl border border-[#28B8B4]/20 dark:border-[#28B8B4]/30 group-hover:shadow-3xl transition-all duration-500 h-full flex flex-col">
                <div className="flex items-start gap-6 mb-8">
                  <div className="w-16 h-16 bg-gradient-to-br from-[#28B8B4] to-[#2D50A1] rounded-2xl flex items-center justify-center shadow-xl group-hover:scale-110 transition-transform duration-300 flex-shrink-0">
                    <Target className="h-7 w-7 text-white" />
                  </div>
                  <div>
                    <h3 className="text-3xl font-bold text-[#09193C] dark:text-white mb-2">Our Mission</h3>
                    <div className="w-12 h-1 bg-gradient-to-r from-[#28B8B4] to-[#2D50A1] rounded-full"></div>
                  </div>
                </div>
                <p className="text-[#2D50A1] dark:text-gray-300 text-lg leading-relaxed flex-grow">
                ...
                <div className="mt-8 pt-6 border-t border-[#28B8B4]/20">
                  <div className="flex items-center gap-3 text-[#28B8B4] font-semibold group-hover:gap-4 transition-all duration-300">
            ...
            >
              ...
              <div className="relative bg-white dark:bg-[#09193C] rounded-2xl p-8 shadow-2xl border border-[#F79050]/20 dark:border-[#F79050]/30 group-hover:shadow-3xl transition-all duration-500 h-full flex flex-col">
                <div className="flex items-start gap-6 mb-8">
                  <div className="w-16 h-16 bg-gradient-to-br from-[#F79050] to-[#2D50A1] rounded-2xl flex items-center justify-center shadow-xl group-hover:scale-110 transition-transform duration-300 flex-shrink-0">
                    <Eye className="h-7 w-7 text-white" />
                  </div>
                  <div>
                    <h3 className="text-3xl font-bold text-[#09193C] dark:text-white mb-2">Our Vision</h3>
                    <div className="w-12 h-1 bg-gradient-to-r from-[#F79050] to-[#2D50A1] rounded-full"></div>
                  </div>
                </div>
                <p className="text-[#2D50A1] dark:text-gray-300 text-lg leading-relaxed flex-grow">
                ...
                <div className="mt-8 pt-6 border-t border-[#F79050]/20">
                  <div className="flex items-center gap-3 text-[#F79050] font-semibold group-hover:gap-4 transition-all duration-300">
          ...
          >
            <div className="text-center mb-16">
              <h3 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-[#2D50A1] to-[#28B8B4] bg-clip-text text-transparent">Our Environmental Impact</h3>
              <p className="text-xl text-[#2D50A1] dark:text-gray-400 max-w-2xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
              ...
              >
                <div className="absolute -inset-1 bg-gradient-to-br from-[#28B8B4] to-[#2D50A1] rounded-3xl blur-lg opacity-20 group-hover:opacity-30 transition-all duration-500"></div>
                <div className="relative bg-white dark:bg-[#09193C] rounded-2xl p-8 shadow-2xl border border-[#28B8B4]/20 dark:border-[#28B8B4]/30 group-hover:shadow-3xl transition-all duration-500 h-full">
                  <div className="flex items-center gap-4 mb-6">
                    <div className="w-14 h-14 bg-gradient-to-br from-[#28B8B4] to-[#2D50A1] rounded-2xl flex items-center justify-center shadow-xl group-hover:scale-110 transition-transform duration-300">
                      <Cloud className="h-7 w-7 text-white" />
                    </div>
                    <h4 className="text-2xl font-bold text-[#09193C] dark:text-white">Carbon Emission Reduction</h4>
                  </div>

                  <p className="text-[#2D50A1] dark:text-gray-300 text-lg mb-6">
                    For every unit (kWh) of renewable electricity used, we avoid the grid's average emission factor.
                  </p>

                  <div className="bg-[#28B8B4]/10 rounded-xl p-6 border border-[#28B8B4]/20">
                    <h5 className="font-semibold text-[#09193C] dark:text-white mb-3">Example Calculation:</h5>
                    <p className="text-[#2D50A1] dark:text-gray-300 mb-2">
                    ...
                    <div className="text-3xl font-bold text-[#28B8B4] mb-2">
                      1,312 tons CO₂
                    </div>
                    <p className="text-[#2D50A1] dark:text-gray-300 text-sm">
                      emission reduction per year
                    </p>
                    <div className="mt-3 text-xs text-[#2D50A1] dark:text-gray-400">
              ...
              >
                <div className="absolute -inset-1 bg-gradient-to-br from-[#F79050] to-[#2D50A1] rounded-3xl blur-lg opacity-20 group-hover:opacity-30 transition-all duration-500"></div>
                <div className="relative bg-white dark:bg-[#09193C] rounded-2xl p-8 shadow-2xl border border-[#F79050]/20 dark:border-[#F79050]/30 group-hover:shadow-3xl transition-all duration-500 h-full">
                  <div className="flex items-center gap-4 mb-6">
                    <div className="w-14 h-14 bg-gradient-to-br from-[#F79050] to-[#2D50A1] rounded-2xl flex items-center justify-center shadow-xl group-hover:scale-110 transition-transform duration-300">
                      <TreePine className="h-7 w-7 text-white" />
                    </div>
                    <h4 className="text-2xl font-bold text-[#09193C] dark:text-white">Tree Equivalent Sustainability</h4>
                  </div>

                  <div className="space-y-4 mb-6">
                    <p className="text-[#2D50A1] dark:text-gray-300 text-lg">
                      1 mature tree absorbs about <span className="font-bold text-[#F79050]">22 kg CO₂</span> per year (≈ 0.022 tons).
                    </p>
                    <div className="bg-[#F79050]/10 rounded-xl p-4 border border-[#F79050]/20">
                      <div className="text-2xl font-bold text-[#F79050] mb-2">
                        1 MWh ≈ 37 Trees
                      </div>
                      <p className="text-[#2D50A1] dark:text-gray-300 text-sm">
                  ...
                  <div className="bg-white dark:bg-[#09193C] rounded-lg p-4 border border-[#28B8B4]/20">
                    <p className="text-[#2D50A1] dark:text-gray-300 text-sm">
