...
const Home = () => {
  ...
  const slides = [
    {
      ...
      button1: "Get Started",
      button2: "Calculate Savings",
      stats: "Save 20-40% on Energy Bills"
    },
    {
      id: 2,
      title: "Energy as Automated | Affordable | Sustainable service",
      description: "We provide green power directly from renewable energy partners through Open Access, GEOA and Virtual Power Purchase models.",
    ...
    },
    {
      ...
      button1: "Get Quote",
      button2: "Learn More",
      stats: "Meet RPO Compliance Effortlessly"
    }
  ];
  ...
  return (
    <>
            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <motion.div
                  ...
                  className="inline-flex items-center gap-2 bg-[#28B8B4] backdrop-blur-sm text-white px-4 py-2 rounded-full text-sm font-medium mb-6 mx-auto"
                >
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                  ...
                  <Button
                    ...
                    variant="outline"
                    size="lg"
                    className="text-lg px-8 py-6 border-2 border-white text-white bg-white/10 backdrop-blur-md hover:bg-white hover:text-[#09193C] transition-all duration-300 group"
                  >
                    <Link to="/" className="flex items-center">
                ...
                <motion.div
                  ...
                  className="flex flex-wrap gap-8 mt-12 justify-center hidden md:flex"
                >
                  {[
                    { value: "20-40%", label: "Cost Savings" },
                    { value: "100%", label: "RPO Compliance" },
                    { value: "Zero", label: "Capex Required" }
                  ].map((stat, index) => (
                    <div key={index} className="text-center">
                      <div className="text-2xl font-bold text-[#FFF8F5]">{stat.value}</div>
      ...
      {/* Include About Component at the End */}
      <About />
    </>
  );
};
